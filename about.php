...
$content .= '<p>Daily Promise was written by <a href="http://ianrenton.com/about-me">Ian Renton</a>, a software engineer and self-confessed net-junkie who regularly fails to keep every health-related promise he sets.</p>';
...
$content .= '<p>It\'s also free in the sense that the code behind it is licenced under the <a href="http://opensource.org/licenses/BSD-2-Clause">BSD Licence</a>, and is available for download at <a href="https://github.com/ianrenton/DailyPromise">Github</a>.</p>';
